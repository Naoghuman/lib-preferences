...
final class FilePreferences extends AbstractPreferences {
    ...
    public static File getPreferencesFile() {
        if (preferencesFile == null) {
            ...
            log.finer("Preferences file is " + preferencesFile); // NOI18N
        }
    ...
    protected final void flushSpi() throws BackingStoreException {
        ...
        synchronized (file) {
            ...
            try {
                ...
                p.store(new FileOutputStream(file), "This file is automatically generated. Plz don't modified it manuelly."); // NOI18N
            } catch (IOException e) {
                throw new BackingStoreException(e);
            }
        }
